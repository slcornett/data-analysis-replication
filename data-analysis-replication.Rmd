...
s %>% dplyr::filter(skim_type == "numeric") %>%
  ...
  kable_styling(font_size = 10, full_width = FALSE) # font-size
...
• one visualization
• one inferential statistical analysis
